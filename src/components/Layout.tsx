          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {profile && !isUniversityStudent && (
              <div className="relative">
                ...
                >
                  ...
                  <span>
                    {language === 'si' ? `${profile.grade} ශ්‍රේණිය` : language === 'ta' ? `தரம் ${profile.grade}` : `Grade ${profile.grade}`}
                  </span>
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-bold rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 transition shadow-xs"
              ...
              {showLangDropdown && (
                <div className="absolute right-0 mt-2 w-44 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 p-1.5 z-50 animate-in fade-in slide-in-from-top-2">
